            ...
            SEL_MI_WARNING( //
                    Doc.of(Level.WARNING) //
                            .text("Microinverter WARNING (derived): non-fatal condition, e.g. derating or missing PV inputs. "
                                    + "May be present together with SEL_MI_HAS_ALARM depending on alarm-bit classification.")),

            SEL_MI_FAULT( //
                    Doc.of(Level.FAULT) //
                            .text("Microinverter FAULT (derived): fatal condition that stops operation. "
                                    + "Derived from status and alarm bits; see SEL_MI_ALARM_SUMMARY for details.")),
